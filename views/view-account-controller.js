...
const viewAccountConroller = {};

viewAccountConroller.edit = (data, callback) => {
  ...
  if(data.method == 'get'){
   ...
   helpers.getTemplate('account-edit', templateData, (err, str) => {
     if(!err && str){
...
module.exports = viewAccountConroller;